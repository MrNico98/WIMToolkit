...
::Extra 
 ...
 if errorlevel 7 goto :menuprincipale
 if errorlevel 6 goto :delwinre
...
::Aggiungi Componenti  
 ...
 cls
 IF "%os%" equ "" ( echo Seleziona prima ^<Monta ISO^> && timeout 4 >NUL && goto :menuprincipale )
 IF "%os%" equ "10" ( echo In arrivo con aggiornamenti futuri && timeout 4 >NUL && goto :menuprincipale ) 
 IF "%os%" equ "11" ( echo In arrivo con aggiornamenti futuri && timeout 4 >NUL && goto :menuprincipale )
 ...
 echo ===================================================
 choice /C:12X /N /M "Digita un numero: " 
 if errorlevel X goto :menuprincipale 
 ...
 :visualc
 echo In arrivo con aggiornamenti futuri && timeout 4 >NUL && goto :aggiungicomeponenti
::############################################################################################################################## 
::Vari Tweaks
 :disabcortana 
 reg load HKLM\TK_COMPONENTS "%mount%\Windows\System32\config\COMPONENTS" 
